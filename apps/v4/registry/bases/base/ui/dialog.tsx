...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn("cn-dialog-overlay fixed inset-0 isolate z-150", className)}
      {...props}
    />
  )
}
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "cn-dialog-content fixed top-1/2 left-1/2 z-150 w-full -translate-x-1/2 -translate-y-1/2 outline-none",
          className
        )}
        {...props}
      >
