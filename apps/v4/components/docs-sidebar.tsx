...
export function DocsSidebar({
  ...
  return (
    <Sidebar
      className="sticky top-[calc(var(--header-height)+0.6rem)] z-99 hidden h-[calc(100svh-10rem)] overflow-hidden overscroll-none bg-transparent [--sidebar-menu-width:--spacing(56)] lg:flex"
      collapsible="none"
      {...props}
    >
